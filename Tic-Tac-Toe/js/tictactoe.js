...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === "O") {
            ...
            // This condition disables clicking for computers turn.
            disableClick();
    ...
    function computerTurn() {
        ...
        // This condition allows our while loop to keep traying if a square is selected already.
        while (!success) {
...
// This function takes a stri ng parameter of the path you set earlier for
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    let x1 = coordX1,
        ...
        // This line indicates where the start of a lines y asis is.
        y1 = coordY1,
        ...
        // This variable stores temporary x asis data we update in our animation loop.
        x = x1,

        // This variable stores temporary y asis data we update in our animation loop.
        y = y1;
    ...
    // This function clears our cannvas after our win line is drawn.
    function clear() {
